...
#define UEVT_FSM_BASE (0xBF00)
#define UEVT_FSM_NULL (UEVT_FSM_BASE | 0x00)
#define UEVT_FSM_STATE_CHANGE (UEVT_FSM_BASE | 0x01)

#define UEVT_RTC_BASE (0x0000)
#define UEVT_TIMER_4HZ (UEVT_RTC_BASE | 0x10)
#define UEVT_TIMER_64HZ (UEVT_RTC_BASE | 0x11)
#define UEVT_TIMER_100HZ (UEVT_RTC_BASE | 0x12)
...
#define UEVT_BTN_BOTH_DOWN (UEVT_BTN_BASE | 0x21)
#define UEVT_BTN_BOTH_RELEASE (UEVT_BTN_BASE | 0x22)
